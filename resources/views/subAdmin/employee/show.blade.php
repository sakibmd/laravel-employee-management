...
<br>
   ...
   <a href="{{ route('subadmin.employee.index') }}" class="btn btn-danger wave-effect" >BACK</a>
   <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal"> Change Contact Number</button>
   <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#changeBin">Change Bin Number</button>
    <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#changeEmail">Change Email Address</button>
